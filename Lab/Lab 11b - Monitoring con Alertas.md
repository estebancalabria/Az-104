...
2. Hacer deploy de un custom template
...
```
3. Por las dudas creamos un Log analicits Worskpace
...
5. Configura el monitor de la VM (Forma facil)

> ir a la opcion Monitor \ Insights \ Virtual Machine 
